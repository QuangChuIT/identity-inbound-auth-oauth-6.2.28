...
/**
 * OAuth2TokenValidationRequestDTO_TokenValidationContextParam.java
 *
 ...
 */
            ...
            /**
            *  OAuth2TokenValidationRequestDTO_TokenValidationContextParam bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OAuth2TokenValidationRequestDTO_TokenValidationContextParam
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = OAuth2TokenValidationRequestDTO_TokenValidationContextParam
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OAuth2TokenValidationRequestDTO_TokenValidationContextParam",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static OAuth2TokenValidationRequestDTO_TokenValidationContextParam parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OAuth2TokenValidationRequestDTO_TokenValidationContextParam object =
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OAuth2TokenValidationRequestDTO_TokenValidationContextParam".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OAuth2TokenValidationRequestDTO_TokenValidationContextParam)org.wso2.carbon.identity.oauth2.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.oauth2.identity.carbon.wso2.org/xsd","key").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.oauth2.identity.carbon.wso2.org/xsd","value").equals(reader.getName())){
