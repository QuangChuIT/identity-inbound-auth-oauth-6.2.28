...
/**
 * UpdateApproveAlwaysForAppConsentByResourceOwner.java
 *
 ...
 */
            ...
            /**
            *  UpdateApproveAlwaysForAppConsentByResourceOwner bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateApproveAlwaysForAppConsentByResourceOwner
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":updateApproveAlwaysForAppConsentByResourceOwner",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "updateApproveAlwaysForAppConsentByResourceOwner",
    ...
    public static class Factory{
        ...
        */
        public static UpdateApproveAlwaysForAppConsentByResourceOwner parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UpdateApproveAlwaysForAppConsentByResourceOwner object =
                new UpdateApproveAlwaysForAppConsentByResourceOwner();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"updateApproveAlwaysForAppConsentByResourceOwner".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateApproveAlwaysForAppConsentByResourceOwner)org.wso2.carbon.identity.oauth.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","appName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","state").equals(reader.getName())){
