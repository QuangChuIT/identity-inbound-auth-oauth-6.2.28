 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for AuthorizationContextToken
                        */

                        
                                    protected org.wso2.carbon.identity.oauth2.stub.dto.OAuth2TokenValidationResponseDTO_AuthorizationContextToken localAuthorizationContextToken ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAuthorizationContextTokenTracker = false ;

                           public boolean isAuthorizationContextTokenSpecified(){
                               return localAuthorizationContextTokenTracker;
                           }
                           ...
                           * @return org.wso2.carbon.identity.oauth2.stub.dto.OAuth2TokenValidationResponseDTO_AuthorizationContextToken
                           */
                           public  org.wso2.carbon.identity.oauth2.stub.dto.OAuth2TokenValidationResponseDTO_AuthorizationContextToken getAuthorizationContextToken(){
                               return localAuthorizationContextToken;
                           }
                            ...
                            /**
                               ...
                               * @param param AuthorizationContextToken
                               */
                               public void setAuthorizationContextToken(org.wso2.carbon.identity.oauth2.stub.dto.OAuth2TokenValidationResponseDTO_AuthorizationContextToken param){
                            localAuthorizationContextTokenTracker = true;
                                   
                                            this.localAuthorizationContextToken=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localAuthorizationContextTokenTracker){
                                    if (localAuthorizationContextToken==null){

                                        writeStartElement(null, "http://dto.oauth2.identity.carbon.wso2.org/xsd", "authorizationContextToken", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localAuthorizationContextToken.serialize(new javax.xml.namespace.QName("http://dto.oauth2.identity.carbon.wso2.org/xsd","authorizationContextToken"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localAuthorizationContextTokenTracker){
                            elementList.add(new javax.xml.namespace.QName("http://dto.oauth2.identity.carbon.wso2.org/xsd",
                                    ...
                                    elementList.add(localAuthorizationContextToken==null?null:
                                    localAuthorizationContextToken);
                                } if (localAuthorizedUserTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://dto.oauth2.identity.carbon.wso2.org/xsd",
                                                                      "authorizedUser"));
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OAuth2TokenValidationResponseDTO".equals(type)){
                                ...
                                return (OAuth2TokenValidationResponseDTO)org.wso2.carbon.identity.oauth2.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list5 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://dto.oauth2.identity.carbon.wso2.org/xsd","authorizationContextToken").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setAuthorizationContextToken(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setAuthorizationContextToken(org.wso2.carbon.identity.oauth2.stub.dto.OAuth2TokenValidationResponseDTO_AuthorizationContextToken.Factory.parse(reader));
