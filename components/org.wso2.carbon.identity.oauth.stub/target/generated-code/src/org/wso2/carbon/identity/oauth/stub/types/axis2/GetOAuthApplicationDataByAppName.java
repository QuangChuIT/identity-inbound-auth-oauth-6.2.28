...
/**
 * GetOAuthApplicationDataByAppName.java
 *
 ...
 */
            ...
            /**
            *  GetOAuthApplicationDataByAppName bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetOAuthApplicationDataByAppName
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getOAuthApplicationDataByAppName",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getOAuthApplicationDataByAppName",
    ...
    public static class Factory{
        ...
        */
        public static GetOAuthApplicationDataByAppName parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetOAuthApplicationDataByAppName object =
                new GetOAuthApplicationDataByAppName();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getOAuthApplicationDataByAppName".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetOAuthApplicationDataByAppName)org.wso2.carbon.identity.oauth.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
