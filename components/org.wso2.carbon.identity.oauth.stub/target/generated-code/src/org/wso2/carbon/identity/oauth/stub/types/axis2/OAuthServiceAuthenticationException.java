 ...
 */
            ...
            /**
            *  OAuthServiceAuthenticationException bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class OAuthServiceAuthenticationException
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":OAuthServiceAuthenticationException",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "OAuthServiceAuthenticationException",
                ...
                if (localAuthenticationExceptionTracker){
                                    if (localAuthenticationException==null){
                                        ...
                                        writeStartElement(null, "http://org.apache.axis2/xsd", "AuthenticationException", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localAuthenticationException.serialize(new javax.xml.namespace.QName("http://org.apache.axis2/xsd","AuthenticationException"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static OAuthServiceAuthenticationException parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            OAuthServiceAuthenticationException object =
                new OAuthServiceAuthenticationException();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"OAuthServiceAuthenticationException".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (OAuthServiceAuthenticationException)org.wso2.carbon.identity.oauth.stub.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://org.apache.axis2/xsd","AuthenticationException").equals(reader.getName())){
